...
const useMatchingStore = create((set, get) => ({
  ...
  fetchMatches: async () => {
    try {
      ...
      const response = await fetch('https://new-peer-1.onrender.com/api/users/matches', {
        method: 'GET',
        headers: {
  ...
  connectWithPeer: async (peerId) => {
    try {
      ...
      const response = await fetch('https://new-peer-1.onrender.com/api/users/add-friend', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  disconnectFromPeer: async (peerId) => {
    try {
      ...
      const response = await fetch('https://new-peer-1.onrender.com/api/users/remove-friend', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
